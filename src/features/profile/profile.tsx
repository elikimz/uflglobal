  ...
  return (
    ...
    >
      ...
      <div className="space-y-3 mb-20">
        ...
        {/* App Download - Now with PWA Install Button */}
        {showInstallButton ? (
          <button
            onClick={handleInstallClick}
            className="bg-yellow-100 p-4 rounded-lg shadow flex justify-between items-center w-full"
          >
            <div className="flex items-center">
              <DevicePhoneMobileIcon className="h-5 w-5 text-yellow-600 mr-2" />
              <span className="text-yellow-800">Install App</span>
            </div>
            <ArrowRightOnRectangleIcon className="h-5 w-5 text-yellow-600" />
          </button>
        ) : (
