          ...
          <table className="min-w-full bg-white/5 backdrop-blur-xl border border-white/20 rounded-2xl shadow">
            ...
            <tbody>
              {filteredWithdrawals.map((w: any) => {
                ...
                // Use only bank_account_number as the account number
                const accountNumber = w.bank_account_number || "N/A";
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-3 whitespace-nowrap text-sm text-yellow-100">
                      {w.account_name}
                    </td>
                    <td className="px-6 py-3 whitespace-nowrap text-sm text-yellow-100 flex items-center gap-1">
                      {accountNumber}
                      <button
