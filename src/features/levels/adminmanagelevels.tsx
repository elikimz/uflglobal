...
//     e.preventDefault();
//     try {
//       // normalize and convert numeric fields from strings to numbers
//       const payloadData = {
//         name: form.name,
...
//         // updateLevel expects an object with level_id and data
//         await updateLevel({ level_id: Number(form.id), data: payloadData }).unwrap();
//       } else {
//         // createLevel expects the payload data for a new level
