    ...
    <AnimatePresence>
      {!isExiting && (
        ...
        >
          ...
          {/* WhatsApp and Hiring Manager Icons */}
          <div className="fixed md:bottom-32 bottom-24 right-4 flex flex-col gap-2 z-[100]">
            {links && links.length > 0 ? (
                ...
                <div key={link.id} className="flex flex-col gap-2">
                  {link.whatsapp_link && (
                    <motion.div
                      ...
                      className="w-14 h-14 bg-green-500 rounded-full flex items-center justify-center cursor-pointer shadow-lg border-2 border-white"
                    >
                      <img
                        ...
                        className="h-8 w-8"
                        onError={(e) => {
                          e.currentTarget.src = '/fallback-whatsapp-icon.png';
                        }}
                      />
                    </motion.div>
                  )}
                  {link.hiring_manager_link && (
                    <motion.div
                      ...
                      className="w-14 h-14 rounded-full cursor-pointer shadow-lg overflow-hidden border-2 border-white"
                    >
                      <img
                        ...
                        onError={(e) => {
                          e.currentTarget.src = '/fallback-hiring-icon.png';
                        }}
                      />
                    </motion.div>
                  )}
              ...
              <div className="w-14 h-14 bg-gray-300 rounded-full flex items-center justify-center text-xs text-gray-600">
                No Links
              </div>
            )}
          </div>
