...
//               <div className="text-xl font-bold text-yellow-800">RXM</div>

//               {/* Level badge */}
//               {!isLoading && userProfile && (
//                 <div className="relative">
//                   <div className="bg-yellow-400/30 rounded-full px-4 py-1 border-2 border-yellow-500 flex items-center gap-1">
...
//           {/* MAIN ICON GRID - 3 columns */}
//           <div className="grid grid-cols-3 gap-4 px-4 mt-4">
//             {[
//               {
//                 icon: <FlagIcon className="h-8 w-8 text-yellow-600" />,
//                 label: "Company Activities",
//                 path: "/company-activity",
//               },
//               {
//                 icon: <MegaphoneIcon className="h-8 w-8 text-yellow-600" />,
//                 label: "News",
//                 path: "/company-news",
//               },
//               {
//                 icon: <GiftIcon className="h-8 w-8 text-yellow-600" />,
//                 label: "Member Benefits",
//                 path: "/member-benefits",
//               },
//               {
...
//               },
//               {
//                 icon: <UserPlusIcon className="h-8 w-8 text-yellow-600" />,
//                 label: "Team Expansion",
//                 path: "/team-management",
//               },
//               {
...
//                 whileTap={{ scale: 0.95 }}
//                 onClick={() => handleNavigation(item.path)}
//                 className="bg-yellow-100 rounded-xl p-4 flex flex-col items-center justify-center shadow-sm"
//               >
