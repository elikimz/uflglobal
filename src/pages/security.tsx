...
//       <section className="max-w-3xl mx-auto bg-yellow-100 backdrop-blur-xl border border-yellow-200 p-6 rounded-2xl shadow">
//         <h2 className="text-xl font-semibold text-yellow-800 mb-4 flex items-center gap-2">
...
//           <div>
//             <label className="block text-yellow-700 mb-1">M-Pesa Number</label>
//             <input
//               type="text"
...
//           className="w-full bg-yellow-600 hover:bg-yellow-700 transition-colors py-3 rounded-lg font-semibold text-white mt-4"
//         >
