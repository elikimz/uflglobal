...
//                       <div className="text-sm text-gray-500">{withdrawal.user.full_name}</div>
//                     </td>
...
// Level: ${withdrawal.user.level_name}\n
// M-Pesa: ${withdrawal.user.mpesa_number || 'N/A'}\n
// Bank: ${withdrawal.user.bank_name || 'N/A'} ${withdrawal.user.bank_account_number || ''}\n
// Balance: KES ${withdrawal.user.wallet_balance.toLocaleString()}`);
//                         }}
//                       >
//                         View
//                       </button>
...
//       {/* Summary */}
//       {data && (
//         <div className="mt-6 bg-white p-4 rounded-lg shadow flex flex-wrap justify-between items-center">
//           <div className="text-sm text-gray-600">
//             Showing {filteredWithdrawals?.length || 0} of {data.length} withdrawals
//           </div>
//           <div className="text-lg font-semibold text-gray-800">
//             Total: KES {data.reduce((sum, withdrawal) => sum + withdrawal.amount, 0).toLocaleString()}
//           </div>
//         </div>
//       )}
//     </div>
